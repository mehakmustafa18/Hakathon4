  ...
  return (
    <nav className="navbar">
      ...
      <Link to="/" className="navbar-logo">
        ...
        />
        <span className="text-xl font-bold tracking-tight text-white">StreamVibe</span>
      </Link>
            ...
            {isDropdownOpen && (
              <div className="navbar-dropdown">
                <div className="navbar-dropdown-header">
                  ...
                  <p className="navbar-dropdown-role">{user.role?.replace('_', ' ') || 'User'}</p>
                </div>
                {user.role === 'super_admin' && (
                  <Link to="/admin" className="navbar-dropdown-item">Admin Dashboard</Link>
                )}
                <button 
